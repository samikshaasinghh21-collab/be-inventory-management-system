...
export const normalizeHrmsReview = (review = {}) => {
  ...
  return {
    ...
    reviewDate: review.reviewDate ?? review.ReviewDate ?? "",
    reviewEndDate: review.reviewEndDate ?? review.ReviewEndDate ?? "",
    reviewStartDate: review.reviewStartDate ?? review.ReviewStartDate ?? "",
