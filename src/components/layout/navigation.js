          ...
          createNavItem({
            ...
            children: [
              createNavItem({
                ...
                exact: true,
                icon: "plus",
                subtitle: "Record and manage employee reviews.",
      ...
      createNavItem({
        ...
        children: [
          ...
          createNavItem({
            ...
            subtitle: "Stage checkpoints and the tasks created under each milestone.",
            searchKeywords: ["project timeline", "milestones", "stages", "schedule"],
          }),
          createNavItem({
            ...
            subtitle: "Milestone-owned tasks, owners, priorities, and progress.",
